...
var ProductWhere = struct {
	...
	ExternalID:  whereHelperstring{field: "\"product\".\"external_id\""},
	Name:        whereHelperstring{field: "\"product\".\"name\""},
	Description: whereHelperstring{field: "\"product\".\"description\""},
	Status:      whereHelperstring{field: "\"product\".\"status\""},
	Price:       whereHelperint64{field: "\"product\".\"price\""},
...
var (
	...
	productColumnsWithoutDefault = []string{"external_id", "name", "description", "status", "price"}
...
func (q productQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Product, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "orm: failed to execute a one query for product")
	}
...
func (q productQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "orm: failed to count product rows")
	}
...
func (q productQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "orm: failed to check if product exists")
	}
...
func (o *Product) OrderItems(mods ...qm.QueryMod) orderItemQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"order_item\".\"product_id\"=?", o.ID),
	)
...
func (productL) LoadOrderItems(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProduct interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`order_item`),
		qm.WhereIn(`order_item.product_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func FindProduct(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Product, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "orm: unable to select from product")
	}
...
func (o *Product) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("orm: no product provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "orm: unable to insert into product")
	}
...
func (o *Product) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("orm: unable to update product, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to update product row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "orm: failed to get rows affected by update for product")
	}
...
func (q productQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to update all for product")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to retrieve rows affected for product")
	}
...
func (o *Product) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("orm: no product provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("orm: unable to upsert product, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "orm: unable to upsert product")
	}
...
func (o *Product) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to delete from product")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "orm: failed to get rows affected by delete for product")
	}
...
func (q productQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to delete all from product")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "orm: failed to get rows affected by deleteall for product")
	}
...
func ProductExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "orm: unable to check if product exists")
	}
